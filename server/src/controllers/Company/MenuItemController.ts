...
export class MenuItemController extends Validator {
    ...
    onCreateMenuItem = async (req: Request, res: Response, next: NextFunction) => {
        ...
        var body = { name: req.body.name, price: parseFloat(req.body.price), pointValue: parseFloat(req.body.pointValue), size: req.body.size, place: { connect: { id: parseInt(req.body.placeId) } }, image: req.file }
