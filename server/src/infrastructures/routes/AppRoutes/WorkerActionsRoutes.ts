...
import { earnedPlacePointMenuItemRepository, earnedPlacePointRepository, placeRepository, placeWorkerRepository, userRecordRepository, userRepository } from "../../repositories/PrismaRepository";
...
const controller = new WorkerActionsController(placeWorkerInteractor, earnedPointMenuItemInteractor, earnedPlacePointInteractor, placeRecordInteractor, userInteractor, placeInteractor)
